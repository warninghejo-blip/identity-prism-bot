"""Auto-restart wrapper for the Twitter bot (main.py).
...
LOG_FILE = BOT_DIR / 'bot.err.log'
LOCK_FILE = BOT_DIR / 'twitter_bot.lock'
CHILD_PID_FILE = BOT_DIR / 'twitter_bot_child.pid'
SCRIPT = 'main.py'
MIN_UPTIME = 30
MAX_BACKOFF = 300
